...
public class Capabilities implements Serializable {
     ...
     */
    public static final String NS_NOTIFICATION = URN_IETF_PARAMS_XML_NS_NETCONF + "notification:1.0";

    /**
     * The NETCONF partial lock namespace.
     * "urn:ietf:params:xml:ns:netconf:partial-lock:1.0"
     */
    public static final String NS_PARTIAL_LOCK = URN_IETF_PARAMS_XML_NS_NETCONF + "partial-lock:1.0";
     ...
     */
    public static final String NETCONF_BASE_CAPABILITY = URN_IETF_PARAMS + "netconf:base:1.0";

    /**
     * String constant for the <code>:writable-running</code> capability.
     * "urn:ietf:params:netconf:capability:writable-running:1.0".
     */
    public static final String WRITABLE_RUNNING_CAPABILITY =
            URN_IETF_PARAMS + "netconf:capability:writable-running:1.0";
     ...
     */
    public static final String CANDIDATE_CAPABILITY = URN_IETF_PARAMS_NETCONF + "capability:candidate:1.0";

    /**
     * String constant for the <code>:confirmed-commit</code> capability.
     * "urn:ietf:params:netconf:capability:confirmed-commit:1.0".
     */
    public static final String CONFIRMED_COMMIT_CAPABILITY =
            URN_IETF_PARAMS + "netconf:capability:confirmed-commit:1.0";

    /**
     * String constant for the <code>:rollback-on-error</code> capability.
     * "urn:ietf:params:netconf:capability:rollback-on-error:1.0".
     */
    public static final String ROLLBACK_ON_ERROR_CAPABILITY =
            URN_IETF_PARAMS + "netconf:capability:rollback-on-error:1.0";

    /**
     * String constant for the <code>:validate</code> capability.
     * "urn:ietf:params:netconf:capability:validate:1.0".
     */
    public static final String VALIDATE_CAPABILITY = URN_IETF_PARAMS_NETCONF + "capability:validate:1.0";

    /**
     * String constant for the <code>:startup</code> capability.
     * "urn:ietf:params:netconf:capability:startup:1.0".
     */
    public static final String STARTUP_CAPABILITY = URN_IETF_PARAMS_NETCONF + "capability:startup:1.0";

    /**
     * String constant for the <code>:url</code> capability.
     * "urn:ietf:params:netconf:capability:url:1.0".
     */
    public static final String URL_CAPABILITY = URN_IETF_PARAMS_NETCONF + "capability:url:1.0";

    public static final String URL_CAPABILITY_SCHEME = URN_IETF_PARAMS_NETCONF + "capability:url:1.0?scheme=";

    /**
     * String constant for the <code>:xpath</code> capability.
     * "urn:ietf:params:netconf:capability:xpath:1.0".
     */
    public static final String XPATH_CAPABILITY = URN_IETF_PARAMS_NETCONF + "capability:xpath:1.0";

    /**
     * String constant for the <code>:notification</code> capability.
     * "urn:ietf:params:netconf:capability:notification:1.0".
     */
    public static final String NOTIFICATION_CAPABILITY = URN_IETF_PARAMS_NETCONF + "capability:notification:1.0";

    /**
     * String constant for the <code>:interleave</code> capability.
     * "urn:ietf:params:netconf:capability:interleave:1.0".
     */
    public static final String INTERLEAVE_CAPABILITY = URN_IETF_PARAMS_NETCONF + "capability:interleave:1.0";

    /**
     * String constant for the <code>:partial-lock</code> capability.
     * "urn:ietf:params:netconf:capability:partial-lock:1.0"
     */
    public static final String PARTIAL_LOCK_CAPABILITY = URN_IETF_PARAMS_NETCONF + "capability:partial-lock:1.0";
     ...
     */
    public static final String NS_ACTIONS = HTTP_TAIL_F_COM + "ns/netconf/actions/1.0";

    /**
     * The NETCONF transactions namespace.
     * "http://tail-f.com/ns/netconf/transactions/1.0"
     */
    public static final String NS_TRANSACTIONS = HTTP_TAIL_F_COM + "ns/netconf/transactions/1.0";
     ...
     * "http://tail-f.com/ns/netconf/actions/1.0".
     */
    public static final String ACTIONS_CAPABILITY = HTTP_TAIL_F_COM + "ns/netconf/actions/1.0";

    /**
     * String constant for the <code>:transactions</code> capability.
     * "http://tail-f.com/ns/netconf/transactions/1.0".
     */
    public static final String TRANSACTIONS_CAPABILITY = HTTP_TAIL_F_COM + "ns/netconf/transactions/1.0";

    /**
     * String constant for the <code>:with-defaults</code> capability.
     * "http://tail-f.com/ns/netconf/with-defaults/1.0".
     */
    public static final String WITH_DEFAULTS_CAPABILITY = HTTP_TAIL_F_COM + "ns/netconf/with-defaults/1.0";


    public static final List<String> EMBED_SCHEMAS = Collections.unmodifiableList(
            Arrays.asList(NS_NETCONF, NS_NOTIFICATION, NS_PARTIAL_LOCK, URN_IETF_PARAMS, NETCONF_BASE_CAPABILITY,
                    WRITABLE_RUNNING_CAPABILITY, URN_IETF_PARAMS_NETCONF, CANDIDATE_CAPABILITY,
                    CONFIRMED_COMMIT_CAPABILITY, ROLLBACK_ON_ERROR_CAPABILITY, VALIDATE_CAPABILITY, STARTUP_CAPABILITY,
                    URL_CAPABILITY, XPATH_CAPABILITY, NOTIFICATION_CAPABILITY, INTERLEAVE_CAPABILITY,
                    PARTIAL_LOCK_CAPABILITY));
    private final ArrayList<Capa> capas;
    private final ArrayList<Capa> dataCapas;
    /*
     * Capabilites
     */
    ...
    protected Capabilities(Element e) throws JNCException {
        ...
        dataCapas = new ArrayList<Capa>(caps.size());
        ...
        for (int i = 0; i < caps.size(); i++) {
            ...
            if (uri.equals(NETCONF_BASE_CAPABILITY)) {
                ...
                urlCapability = true;
                final String schemes = cap.value.toString().substring(URL_CAPABILITY_SCHEME.length());
                ...
                baseCapability = true;
            } else if (uri.equals(URN_IETF_PARAMS_XML_NS_NETCONF + "capability:candidate:1.0")) {
                candidateCapability = true;
            } else if (uri.equals(URN_IETF_PARAMS_XML_NS_NETCONF + "capability:confirmed-commit:1.0")) {
                confirmedCommitCapability = true;
            } else if (uri.equals(URN_IETF_PARAMS_XML_NS_NETCONF + "capability:validate:1.0")) {
                validateCapability = true;
            } else if (uri.equals(URN_IETF_PARAMS_XML_NS_NETCONF + "capability:url:1.0")) {
                urlCapability = true;
                if (parts[1] != null) {
                ...
                dataCapas.add(new Capa(uri, rev));
            }
        }
    }
    ...
    public ArrayList<Capa> getDataCapas() {
        return dataCapas;
    }

    public static class Capa implements Serializable {
        private String uri;
        ...
        public String toString() {
            return "Capa{" + "uri='" + uri + '\'' + ", revision='" + revision + '\'' + '}';
        }
    }
}
