...
public class XMLParser {
    ...
    public Element readFile(String filename) throws JNCException {
        try {
            ...
            throw new JNCException(JNCException.PARSER_ERROR, "parse file: " + filename + " error: " + e);
        }
    }
    ...
    public Element parse(InputSource is) throws JNCException {
        try {
            ...
            throw new JNCException(JNCException.PARSER_ERROR, "parse error: " + e);
        }
    }
    ...
    public Element parse(String str) throws JNCException {
        final ByteArrayInputStream istream = new ByteArrayInputStream(str.getBytes());
    ...
    private class ConfHandler extends DefaultHandler {
        ...
        private Element top;
        private PrefixMap prefixes = null;
