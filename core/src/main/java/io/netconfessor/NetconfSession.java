...
import io.netconfessor.notification.NotificationProcessor;
import io.netconfessor.notification.SystemNotificationProcessor;
...
public class NetconfSession {
    ...
    /**
     * The <code>DATABASE</code> datastore.
     * Datastore Eltex GridFS
     */
     ...
     */
    private Attribute withDefaultsAttr = null;
    /**
    ...
    private NotificationProcessor notificationProcessor =
            new SystemNotificationProcessor();
    ...
    protected void hello() throws JNCException, IOException {
        ...
        if (capatree == null) {
            throw new JNCException(JNCException.SESSION_ERROR, "hello contains no capabilities");
        }
        ...
        if (!capabilities.baseCapability) {
            throw new JNCException(JNCException.SESSION_ERROR,
                    "server does not support NETCONF base capability: " + Capabilities.NETCONF_BASE_CAPABILITY);
        }
        // lookup session id
        final Element sess = t.getFirst("self::hello/session-id");
        if (sess == null) {
            throw new JNCException(JNCException.SESSION_ERROR, "hello contains no session identifier");
        }
     ...
     */
    protected Element rpc(Element request) throws IOException, JNCException {
    ...
    public NodeSet getConfig(int datastore, Element subtreeFilter) throws JNCException, IOException {
        ...
        sb.append(datastoreToString(datastore));
        if (subtreeFilter != null) {
            sb.append('\n').append(subtreeFilter.toXMLString());
        }
        trace(sb.toString());
        final int mid = encodeGetConfig(out, encodeDatastore(datastore), subtreeFilter);
        out.flush();
        return recvRpcReplyData(mid);
    }
     ...
     * @param xpath     XPath expression
     */
    public NodeSet getConfig(int datastore, String xpath) throws JNCException, IOException {
        trace("getConfig: " + datastoreToString(datastore) + " \"" + xpath + "\"");
        if (!capabilities.xpathCapability) {
            throw new JNCException(JNCException.SESSION_ERROR, "the :xpath capability is not supported by server");
        }
        final int mid = encodeGetConfig(out, encodeDatastore(datastore), xpath);
        out.flush();
        return recvRpcReplyData(mid);
    }
    ...
    public void editConfig(NodeSet configTrees) throws JNCException, IOException {
     ...
     */
    public void editConfig(int datastore, Element configTree) throws JNCException, IOException {
        trace("editConfig: target=" + datastoreToString(datastore) + "\n" + configTree.toXMLString());
        final int mid = encodeEditConfig(out, encodeDatastore(datastore), configTree);
        out.flush();
        recvRpcReplyOk(mid);
    }

    public void editConfig(int datastore, NodeSet configTrees) throws JNCException, IOException {
        trace("editConfig: target=" + datastoreToString(datastore) + "\n" + configTrees.toXMLString());
        final int mid = encodeEditConfig(out, encodeDatastore(datastore), configTrees);
        out.flush();
        recvRpcReplyOk(mid);
    }
     ...
     */
    public void editConfig(int datastore, String url) throws JNCException, IOException {
        trace("editConfig: target=" + datastoreToString(datastore) + " source=" + url);
        final int mid = encodeEditConfig(out, encodeDatastore(datastore), encodeUrl(url));
        out.flush();
        recvRpcReplyOk(mid);
    }
     ...
     */
    public void copyConfig(Element sourceTree, int target) throws JNCException, IOException {
    ...
    public void copyConfig(NodeSet sourceTrees, int target) throws JNCException, IOException {
     ...
     */
    public void copyConfig(Element sourceTree, String targetUrl) throws JNCException, IOException {
        copyConfig(new NodeSet(sourceTree), targetUrl);
    }

    public void copyConfig(NodeSet sourceTrees, String targetUrl) throws JNCException, IOException {
     ...
     * @param target The target datastore
     */
    public void copyConfig(int source, int target) throws JNCException, IOException {
        trace("copyConfig: " + datastoreToString(source) + " " + datastoreToString(target));
        encodeCopyConfig(out, encodeDatastore(source), encodeDatastore(target));
        out.flush();
        recvRpcReplyOk();
    }
     ...
     * @param targetUrl The target URL.
     */
    public void copyConfig(int source, String targetUrl) throws JNCException, IOException {
        trace("copyConfig: source=" + datastoreToString(source) + " target=" + targetUrl);
        encodeCopyConfig(out, encodeDatastore(source), encodeUrl(targetUrl));
        out.flush();
        recvRpcReplyOk();
    }
     ...
     * @param targetUrl The target URL.
     */
    public void copyConfig(String sourceUrl, String targetUrl) throws JNCException, IOException {
     ...
     * @param target    The target datastore
     */
    public void copyConfig(String sourceUrl, int target) throws JNCException, IOException {
        trace("copyConfig: source=" + sourceUrl + " target=" + datastoreToString(target));
        encodeCopyConfig(out, encodeUrl(sourceUrl), encodeDatastore(target));
        out.flush();
        recvRpcReplyOk();
    }
    ...
    public int lockPartial(String[] select) throws JNCException, IOException {
        ...
        if (!capabilities.hasPartialLock()) {
            throw new JNCException(JNCException.SESSION_ERROR, "capability :partial-lock is not supported by server");
        }
    ...
    public void unlockPartial(int lockId) throws JNCException, IOException {
        ...
        if (!capabilities.hasXPath()) {
            throw new JNCException(JNCException.SESSION_ERROR, "capability :xpath is not supported by server");
        }
    ...
    public void commit() throws JNCException, IOException {
        ...
        if (!capabilities.hasCandidate()) {
            throw new JNCException(JNCException.SESSION_ERROR, "the :candidate capability is not supported by server");
        }
    ...
    public void killSession(long sessionId) throws JNCException, IOException {
        ...
        if (sessionId == this.sessionId) {
            throw new JNCException(JNCException.SESSION_ERROR, "illegal to use kill-session on own session id");
        }
    ...
    public void validate(Element configTree) throws JNCException, IOException {
        ...
        if (!capabilities.hasValidate()) {
            throw new JNCException(JNCException.SESSION_ERROR, "capability :validate is not supported by server");
        }
     ...
     */
    public void createSubscription(String streamName, NodeSet eventFilter, String startTime, String stopTime)
            throws IOException, JNCException {
        trace("createSubscription: stream=" + streamName + " filter=" + eventFilter.toXMLString() + " from=" + startTime
                + " to=" + stopTime);
        if (!capabilities.hasNotification()) {
            throw new JNCException(JNCException.SESSION_ERROR, "capability :notification is not supported by server");
        }
        final int mid = encodeCreateSubscription(out, streamName, eventFilter, startTime, stopTime);
        out.flush();
        recvRpcReplyOk(mid);
    }
     ...
     * @see #receiveNotification()
     */
    public void createSubscription(String streamName, String eventFilter, String startTime, String stopTime)
            throws IOException, JNCException {
        trace("createSubscription: stream=" + streamName + " filter=" + eventFilter + " from=" + startTime + " to="
                + stopTime);
        if (!capabilities.hasNotification()) {
            throw new JNCException(JNCException.SESSION_ERROR, "capability :notification is not supported by server");
        }
    ...
    public NodeSet getStreams() throws JNCException, IOException {
        final Element filter = Element.create("urn:ietf:params:xml:ns:netmod:notification", "netconf/streams");
        return get(filter);
    }
    ...
    protected Element recvRpcReplyOk(String mid) throws JNCException, IOException {
        ...
        while (true) {
            ...
            if (t.isNotification()) {
                notificationProcessor.process(t);
                continue;
            }
    ...
    NodeSet recvRpcReplyLockPartial(int mid) throws JNCException, IOException {
        return recvRpcReply("", parser, Integer.toString(mid));
    }

    NodeSet recvCallRpcReply(Element e, int mid) throws JNCException, IOException {
    ...
    NodeSet recvRpcReply(String path, XMLParser parser, String mid) throws JNCException, IOException {
    ...
    void encodeHello(Transport out) {
        ...
        out.println("<capability>" + Capabilities.NETCONF_BASE_CAPABILITY + "</capability>");
    ...
    protected int encodeRpcBegin(Transport out, Attribute attr) {
        final String prefix = Element.DEFAULT_PREFIXES.nsToPrefix(Element.NETCONF_NAMESPACE);
        nc = mkPrefixColon(prefix);
        final String xmlnsAttr = mkXmlnsAttr(prefix, Element.NETCONF_NAMESPACE);
     ...
     * </pre>
     */
    int encodeGetConfig(Transport out, String source, Element subtreeFilter) throws JNCException {
    ...
    String encodeDatastore(int datastore) throws JNCException {
        ...
        throw new JNCException(JNCException.SESSION_ERROR, "unknown datastore: " + datastore);
    }
     ...
     * </pre>
     */
    int encodeEditConfig(Transport out, String target, Element configTree) throws JNCException {
        return encodeEditConfig(out, target, new NodeSet(configTree));
    }

    int encodeEditConfig(Transport out, String target, NodeSet configTrees) throws JNCException {
     ...
     * </pre>
     */
    int encodeEditConfig(Transport out, String target, String url) throws JNCException {
        final int mid = encodeRpcBegin(out);
        out.println("<" + nc + EDIT_CONFIG_GT);
        out.print("<" + nc + TARGET_GT);
        out.print(target);
    ...
    void encodeDefaultOperation(Transport out) throws JNCException {
        switch (defaultOperation) {
            case NOT_SET:
                return;
            case MERGE:
                out.println("<" + nc + "default-operation>merge</" + nc + "default-operation>");
                return;
            case REPLACE:
                out.println("<" + nc + "default-operation>replace</" + nc + "default-operation>");
                return;
            case NONE:
                out.println("<" + nc + "default-operation>none</" + nc + "default-operation>");
                return;
            default:
                throw new JNCException(JNCException.SESSION_ERROR,
    ...
    void encodeTestOption(Transport out) throws JNCException {
        switch (testOption) {
            ...
            case SET:
                if (!capabilities.hasValidate()) {
                    throw new JNCException(JNCException.SESSION_ERROR,
                            "test-option is given but the :validate " + "capability is not supported by server");
                }
            ...
            case TEST_ONLY:
                ...
                return;
            default:
                throw new JNCException(JNCException.SESSION_ERROR, "unknown test-option value: " + testOption);
        }
    }
    ...
    void encodeErrorOption(Transport out) throws JNCException {
        switch (errorOption) {
            case NOT_SET:
                return;
            case STOP_ON_ERROR:
                out.println("<" + nc + "error-option>stop-on-error</" + nc + "error-option>");
                return;
            case CONTINUE_ON_ERROR:
                out.println("<" + nc + "error-option>continue-on-error</" + nc + "error-option>");
                return;
            case ROLLBACK_ON_ERROR:
                if (!capabilities.hasRollbackOnError()) {
                    throw new JNCException(JNCException.SESSION_ERROR,
                            "the :rollback-on-error capability " + "is used but not supported by server");
                }
                out.println("<" + nc + "error-option>rollback-on-error</" + nc + "error-option>");
                return;
            default:
                throw new JNCException(JNCException.SESSION_ERROR, "unknown error-option value: " + errorOption);
        }
    }
     ...
     * </pre>
     */
    int encodeCopyConfig(Transport out, Element sourceTree, String target) throws JNCException {
    ...
    int encodeCopyConfig(Transport out, NodeSet sourceTrees, String target) throws JNCException {
        final int mid = encodeRpcBegin(out);
     ...
     * </pre>
     */
    int encodeCopyConfig(Transport out, String source, String target) throws JNCException {
        final int mid = encodeRpcBegin(out, withDefaultsAttr);
        out.println("<" + nc + COPY_CONFIG_GT);
        out.print("<" + nc + TARGET_GT);
        out.print(target);
    ...
    int encodeLockPartial(Transport out, String[] select) {
        ...
        final String prefix = Element.DEFAULT_PREFIXES.nsToPrefix(Capabilities.NS_PARTIAL_LOCK);
        final String pl = mkPrefixColon(prefix);
        final String xmlnsAttr = mkXmlnsAttr(prefix, Capabilities.NS_PARTIAL_LOCK);
        final int mid = encodeRpcBegin(out);
     ...
     * </pre>
     */
    int encodeValidate(Transport out, Element configTree) throws JNCException {
        final int mid = encodeRpcBegin(out);
     ...
     * </pre>
     */
    int encodeCreateSubscription(Transport out, String stream, String filter, String startTime, String stopTime) {
        final String prefix = Element.DEFAULT_PREFIXES.nsToPrefix(Capabilities.NS_NOTIFICATION);
        final String ncn = mkPrefixColon(prefix);
        final String xmlnsAttr = mkXmlnsAttr(prefix, Capabilities.NS_NOTIFICATION);
     ...
     * </pre>
     */
    int encodeCreateSubscription(Transport out, String stream, NodeSet eventFilter, String startTime, String stopTime)
            throws JNCException {
        final String prefix = Element.DEFAULT_PREFIXES.nsToPrefix(Capabilities.NS_NOTIFICATION);
        final String ncn = mkPrefixColon(prefix);
        final String xmlnsAttr = mkXmlnsAttr(prefix, Capabilities.NS_NOTIFICATION);
    ...
    void encodeAction(Transport out, Element data) throws JNCException {
        final String prefix = Element.DEFAULT_PREFIXES.nsToPrefix(Capabilities.NS_ACTIONS);
    ...
    void checkMid(Element t, String mid) throws JNCException {
        ...
        if (returnedId == null || (!returnedId.equals(mid))) {
            throw new JNCException(JNCException.MESSAGE_ID_MISMATCH,
                    "After sending rpc with message-id=" + mid + ", received rpc-reply with message-id=" + returnedId);
        }
    }
