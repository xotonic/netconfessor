...
public class DeviceUser implements Serializable {
     ...
     */
    public DeviceUser(String localUser, String remoteUser, File pemFile, String keyPassPhrase) {
        this.localUser = localUser;
        this.remoteUser = remoteUser;
     ...
     * Constructor. Creates a user with a local user name, remote user name.
     */
    public DeviceUser(String localUser, String remoteUser, char[] pemPrivateKey, String keyPassPhrase) {
        this.localUser = localUser;
        this.remoteUser = remoteUser;
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("DeviceUser{");
        sb.append("localUser='").append(localUser).append('\'');
        sb.append(", remoteUser='").append(remoteUser).append('\'');
        sb.append(", password='").append(password).append('\'');
        sb.append(", pemFile=").append(pemFile);
        sb.append(", pemPrivateKey=").append(Arrays.toString(pemPrivateKey));
