...
final class Utils {
     ...
     */
    public static void restrict(Object v, Number arg, Operator op) throws YangException {
     ...
     *                       v is not a Number or a String.
     */
    public static void restrict(Number v, BigDecimal arg, Operator op) throws YangException {
    ...
    public static boolean matches(String value, String[] regexes) throws YangException {
