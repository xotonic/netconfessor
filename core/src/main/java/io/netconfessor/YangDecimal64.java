...
public class YangDecimal64 extends YangBaseInt<BigDecimal> {
    ...
    private void setMinMax() throws YangException {
        ...
        final BigDecimal minValue = pow63.negate().movePointLeft(fractionDigits);
    ...
    public void check() throws YangException {
        ...
        final boolean outsideBounds = fractionDigits != null && (fractionDigits < 1 || fractionDigits > 18);
    ...
    public boolean equals(Object obj) {
        if (obj instanceof YangDecimal64) {
            ...
            try {
                ...
                return (fractionDigits.equals(other.fractionDigits) && other.canEqual(this));
