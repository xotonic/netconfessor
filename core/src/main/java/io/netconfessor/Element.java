...
public class Element implements Serializable {
     ...
     * default.
     */
    public static final PrefixMap DEFAULT_PREFIXES = new PrefixMap(
            new Prefix[] {
    ...
    /**
     * This means that shadowed element will be considered while building tagpath
     */
    protected boolean shadowed = false;
    protected boolean isListEntry = false;
    /**
     ...
     */
    public static Element create(String namespace, String pathStr) throws JNCException {
     ...
     * @return A new configuration element tree
     */
    public static Element create(Prefix prefix, String pathStr) throws JNCException {
        final PrefixMap prefixMap = new PrefixMap();
     ...
     * @return A new configuration element tree
     */
    public static Element create(PrefixMap prefixMap, String pathStr) throws JNCException {
     ...
     * context node
     */
    public Element createPath(String namespace, String pathStr) throws JNCException {
     ...
     * context node
     */
    public Element createPath(Prefix prefix, String pathStr) throws JNCException {
        final PrefixMap p = new PrefixMap();
        p.add(prefix);
        return createPath(CREATE_MERGE, p, pathStr);
    }
     ...
     * context node
     */
    public Element createPath(PrefixMap addPrefixes, String pathStr) throws JNCException {
     ...
     * context node
     */
    public Element createPath(int mode, PrefixMap addPrefixes, String pathStr) throws JNCException {
     ...
     * @throws JNCException If child is already a child of another element.
     */
    public int insertChild(Element child, String[] childrenNames) throws JNCException {
        if (child.parent != null) {
            throw new JNCException(JNCException.ELEMENT_ALREADY_IN_USE, this);
        }
    ...
    public Object getValue(String pathStr) throws JNCException {
        ...
        return (nodes != null && !nodes.isEmpty()) ? nodes.getElement(0).getValue() : null;
    }
    ...
    public Element merge(Element root, int op) throws JNCException {
        ...
        if (list.size() > 0) {
            ...
            } else if (op == OP_REPLACE) { // OP_REPLACE
                final Element x1 = (Element) x.clone();
    ...
    public String lookupContextPrefix(String prefix) {
        ...
        return DEFAULT_PREFIXES.prefixToNs(prefix);
    }
    ...
    public String nsToPrefix(String ns) {
        ...
        // as a last resort use the default prefix map
        return DEFAULT_PREFIXES.nsToPrefix(ns);
    }
    ...
    public String getElementPath() {
        ...
        while (top != null) {
            if (top.namespace == null) {
                ...
                if (top.parent != null && top.parent.namespace != null && top.namespace.equals(top.parent.namespace)) {
                    s = strConcat(top.name, s);
                } else {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, namespace, value);
    }
     ...
     * @throws JNCException If a YangElement encode implementation fails.
     */
    protected void encode(Transport out, boolean newlineAtEnd) throws JNCException {
     ...
     * @return Absolute tagpath to this node
     */
    public Tagpath tagpathShadowed() {
        Element e = this;
        int ix = 0;
        while (e != null && !e.shadowed) {
            e = e.parent;
            ix++;
        }
        final Tagpath tp = new Tagpath(ix);
     ...
     */
    public ElementChildrenIterator<? extends Element> iterator(String name) {
     ...
     */
    public Element addChild(String childName) throws Exception {
        final String methodName = "add" + YangElement.normalize(childName);
        final Method addChild = getClass().getMethod(methodName);
        return Element.class.cast(addChild.invoke(this));
    }

    public boolean isNotification() {
        return getFirst("self::notification") != null;
    }

    public boolean isMyMid(String mid) throws JNCException {
        return mid != null && mid.equals(getAttrValue("message-id"));
    }

    public boolean theSame(Element b) {
        if (b == null) {
            return false;
        }
        final boolean sameName = name != null && name.equals(b.name);
        final boolean sameNamespace = namespace != null && namespace.equals(b.namespace);
        return sameName && sameNamespace;
    }

    public Element to(Element target) {
        if (target == null) {
            return this;
        }
