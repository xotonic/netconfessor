...
public class YangBits extends YangBaseInt<BigInteger> {
     ...
     */
    public YangBits(String value, Number mask, String[] smap, int[] imap) throws YangException {
        super(value);
     ...
     * @throws YangException If value does not match mask.
     */
    public YangBits(Number value, Number mask, String[] smap, int[] imap) throws YangException {
     ...
     * (non-Javadoc)
     *
     * @see YangBaseInt#canEqual(java.lang.Object)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see YangBaseType#equals(java.lang.Object)
     */
    @Override
    public boolean equals(Object obj) {
        ...
        if (!other.mask.equals(mask) || other.smap.length != smap.length || other.imap.length != imap.length) {
            return false;
        }
     ...
     * (non-Javadoc)
     *
     * @see YangBaseInt#decode(java.lang.String)
     */
    @Override
