 ...
 */
public abstract class YangBaseType<T> implements YangType<T>, Cloneable {
     ...
     * (non-Javadoc)
     *
     * @see YangType#setValue(java.lang.String)
     */
