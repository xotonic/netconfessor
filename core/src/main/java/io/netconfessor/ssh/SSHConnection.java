...
class SSHConnection {
     ...
     */
    SSHConnection(String host) throws IOException, JNCException {
        this(host, 830, 0);
    }
     ...
     */
    SSHConnection(String host, int port) throws IOException, JNCException {
        this(host, port, 0);
    }
     ...
     */
    SSHConnection(String host, int port, int connectTimeout) throws IOException, JNCException {
     ...
     *                     {@link #close()} first.
     */
    SSHConnection(String host, int port, int connectTimeout, int kexTimeout) throws IOException, JNCException {
        connection = new Connection(host, port);
     ...
     **/
    public void authenticateWithPassword(String user, String password) throws IOException, JNCException {
     ...
     * @param password Password.
     **/
    public void authenticateWithPublicKeyFile(String user, File pemFile, String password)
     ...
     **/
    public void authenticateWithPublicKey(String user, char[] pemPrivateKey, String pass)
            throws IOException, JNCException {
