...
public class YangUnion extends YangBaseType<YangType<?>> {
    ...
    public void check() throws YangException {
        super.check();
        Arrays.stream(memberTypes).filter(memberType -> memberType.equals(value.getClass().getName())).findFirst()
                .orElseThrow(() -> new YangException(YangException.BAD_VALUE, value));
    }
    ...
    public boolean equals(Object obj) {
        return (canEqual(obj) && java.util.Arrays.equals(memberTypes, ((YangUnion) obj).memberTypes) && super
                .equals(obj));
    }
