 ...
 */
public class JNCException extends RuntimeException {
            ...
            try {
                ...
                if (errors != null) {
                    ...
                    for (int i = 0; i < errors.size(); i++) {
                        rpcErrors[i] = new RpcError(errors.get(i), t.prefixes);
                    }
                }
            } catch (final Exception e) {
                System.err.println("rpc-error can't be parsed: " + t.toXMLString());
                e.printStackTrace();
            }
        }
    }
