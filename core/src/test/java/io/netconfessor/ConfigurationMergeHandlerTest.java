...
public class ConfigurationMergeHandlerTest {
    ...
    public void shouldAddChildToExistingElement() throws Exception {
        ...
        final NodeSet result =
                performMerge("shouldAddChildToExistingElement", existingSet, updateSet, "/parent/childB");
    ...
    public void shouldAddMissingElements() throws Exception {
        ...
        final NodeSet result =
                performMerge("shouldAddMissingElements", existingSet, updateSet, "/parent/childA/grandChildA");
    ...
    public void shouldDeleteByLeaf() throws Exception {
        ...
        final NodeSet result =
                performMerge("shouldDeleteByLeaf", existingSet, emptySet, "/parent/childA[leaf=\"value2\"]");
    ...
    public void shouldDeleteEmptyParentElements() throws Exception {
        ...
        final NodeSet result =
                performMerge("shouldDeleteEmptyParentElements", existingSet, emptySet, "/parent/childA/grandChildA");
    ...
    public void shouldDeleteCompleteTree() throws Exception {
        ...
        final NodeSet result =
                performMerge("shouldDeleteCompleteTree", existingSet, emptySet, "/parent/childA/grandChildA");
    ...
    public void shouldReplaceMasterWithFragmentIfXPathIsEmpty() throws Exception {
        ...
        final NodeSet result =
                performMerge("shouldReplaceMasterWithFragmentIfXPathIsEmpty", existingSet, updateSet, "");
    ...
    public void shouldReplaceMasterWithFragmentIfXPathIsRootOnly() throws Exception {
        ...
        final NodeSet result =
                performMerge("shouldReplaceMasterWithFragmentIfXPathIsRootOnly", existingSet, updateSet, "/");
    ...
    public void shouldDoNothingIfFragmentsDoNotMatchPath() throws Exception {
        ...
        final NodeSet result =
                performMerge("shouldDoNothingIfFragmentsDoNotMatchPath", existingSet, updateSet, "/parent/childX");
