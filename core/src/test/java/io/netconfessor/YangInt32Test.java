...
public class YangInt32Test {
    ...
    public void testDecodeString() {
        ...
        assertTrue(i1.decode(Integer.valueOf(Integer.MAX_VALUE).toString()) == Integer.MAX_VALUE);
        try {
        ...
        assertTrue(i1.decode(Integer.valueOf(Integer.MIN_VALUE).toString()) == Integer.MIN_VALUE);
        try {
    ...
    public void testCanEqual() throws YangException {
        ...
        assertTrue("Transitive", !(i1.canEqual(i2) && i2.canEqual(i3)) || i1.canEqual(i3));
    ...
    public void testEqualsObject() throws YangException {
        ...
        assertTrue("Transitive", !(i1.equals(tmp1) && tmp1.equals(tmp3)) || i1.equals(tmp3));
        assertTrue("Transitive", !(i1.equals(s1) && s1.equals(iv1)) || i1.equals(iv1));
        assertTrue("Transitive", !(i1.equals(tmp4) && tmp4.equals(tmp2)) || i1.equals(tmp2));
        assertTrue("Transitive", !(i1.equals(s1) && s1.equals(l1)) || i1.equals(l1));
        assertTrue("Transitive", !(i1.equals(l1) && l1.equals(i1)) || i1.equals(i1));
