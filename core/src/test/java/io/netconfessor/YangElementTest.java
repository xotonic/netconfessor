...
public class YangElementTest {
    ...
    private YangElement a1;
    private YangElement a2;
    private YangElement b1;
    private YangElement b2;
    private Leaf leaf1;
    private Leaf leaf2;
    private NodeSet uniqueA;
    private NodeSet uniqueB;
    private NodeSet changedA;
    private NodeSet changedB;
    ...
    public void setUp() {
        ...
        b1.setPrefix(prefix);
        Attribute[] attrs =
                {new Attribute(ns, "presence", "Always present"), new Attribute(ns, "description", "For testing"),
    ...
    public void shouldProduceValidXmlRegardlessOfLeafNamespace() throws JNCException {
        ...
        String expectedXml = new StringBuilder()
                .append("<a xmlns=\"http://test.com/ns/containertest/1.0\" xmlns:conttest=\"http://test"
                        + ".com/ns/containertest/1.0\" presence=\"Always present\" description=\"For testing\" "
                        + "reference=\"YangElementTest\">\n")
