...
public abstract class CommonVisitor {
    ...
    public void setup() {
        ...
        setupDstenable(new EnumYangData<>("dstenable", "/ap-config:config/ap-config:date-time/ap-config:common/ap-config:dstenable", "Daylight saving time enable", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
