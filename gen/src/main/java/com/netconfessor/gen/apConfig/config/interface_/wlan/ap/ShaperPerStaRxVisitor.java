...
public abstract class ShaperPerStaRxVisitor {
    ...
    public void setup() {
        setupMode(new EnumYangData<>("mode", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:ap/ap-config:shaper-per-sta-rx/ap-config:mode", "Shaper work-mode", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_off_pps_kbps", s -> new Enum_off_pps_kbps(s), Enum_off_pps_kbps.enums()));
