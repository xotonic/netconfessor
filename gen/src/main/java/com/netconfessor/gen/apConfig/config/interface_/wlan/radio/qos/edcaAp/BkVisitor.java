...
import com.netconfessor.gen.apConfig.config.interface_.wlan.radio.qos.edcaAp.Bk;
import com.netconfessor.gen.apConfig.config.interface_.wlan.radio.qos.edcaAp.bk.Acm;
import com.netconfessor.gen.apConfig.config.interface_.wlan.radio.qos.edcaAp.bk.Aifs;
import com.netconfessor.gen.apConfig.config.interface_.wlan.radio.qos.edcaAp.bk.Cwmax;
import com.netconfessor.gen.apConfig.config.interface_.wlan.radio.qos.edcaAp.bk.Cwmin;
import com.netconfessor.gen.apConfig.config.interface_.wlan.radio.qos.edcaAp.bk.Txop;
...
public abstract class BkVisitor {
    ...
    public void setup() {
        ...
        setupCwmin(new EnumYangData<>("cwmin", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:radio/ap-config:qos/ap-config:edca-ap/ap-config:bk/ap-config:cwmin", "Contention window minimum", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_1_3_7_15_31_63_127_255_511_1023", s -> new Enum_1_3_7_15_31_63_127_255_511_1023(s), Enum_1_3_7_15_31_63_127_255_511_1023.enums()));
        setupCwmax(new EnumYangData<>("cwmax", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:radio/ap-config:qos/ap-config:edca-ap/ap-config:bk/ap-config:cwmax", "Contention window maximum", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_1_3_7_15_31_63_127_255_511_1023", s -> new Enum_1_3_7_15_31_63_127_255_511_1023(s), Enum_1_3_7_15_31_63_127_255_511_1023.enums()));
