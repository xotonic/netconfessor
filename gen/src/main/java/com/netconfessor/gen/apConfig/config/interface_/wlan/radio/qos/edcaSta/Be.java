 ...
 * @author jnc.py
 */
public class Be extends YangElement implements YangContainer {
    ...
    /**
     * Constructor for an empty Be object.
     */
    public Be() {
        super(ApConfigSchema.NAMESPACE, "be");
    }
     ...
     */
    public Be cloneShallow() {
        return (Be)cloneShallowContent(new Be());
    }

    public Be cloneWithoutChildren() {
        return new Be();
    }
