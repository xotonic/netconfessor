...
import com.netconfessor.gen.apConfig.config.interface_.wlan.radio.qos.edcaSta.Vi;
import com.netconfessor.gen.apConfig.config.interface_.wlan.radio.qos.edcaSta.vi.Acm;
import com.netconfessor.gen.apConfig.config.interface_.wlan.radio.qos.edcaSta.vi.Aifs;
import com.netconfessor.gen.apConfig.config.interface_.wlan.radio.qos.edcaSta.vi.Cwmax;
import com.netconfessor.gen.apConfig.config.interface_.wlan.radio.qos.edcaSta.vi.Cwmin;
import com.netconfessor.gen.apConfig.config.interface_.wlan.radio.qos.edcaSta.vi.Txop;
...
public abstract class ViVisitor {
    ...
    public void setup() {
        ...
        setupCwmin(new EnumYangData<>("cwmin", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:radio/ap-config:qos/ap-config:edca-sta/ap-config:vi/ap-config:cwmin", "Contention window minimum", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_1_3_7_15_31_63_127_255_511_1023", s -> new Enum_1_3_7_15_31_63_127_255_511_1023(s), Enum_1_3_7_15_31_63_127_255_511_1023.enums()));
        setupCwmax(new EnumYangData<>("cwmax", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:radio/ap-config:qos/ap-config:edca-sta/ap-config:vi/ap-config:cwmax", "Contention window maximum", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_1_3_7_15_31_63_127_255_511_1023", s -> new Enum_1_3_7_15_31_63_127_255_511_1023(s), Enum_1_3_7_15_31_63_127_255_511_1023.enums()));
