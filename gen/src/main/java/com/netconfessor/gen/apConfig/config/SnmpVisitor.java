...
import com.netconfessor.gen.apConfig.config.snmp.Enable;
import com.netconfessor.gen.apConfig.config.snmp.Informsink;
import com.netconfessor.gen.apConfig.config.snmp.Rocommunity;
import com.netconfessor.gen.apConfig.config.snmp.Rwcommunity;
import com.netconfessor.gen.apConfig.config.snmp.Syscontact;
import com.netconfessor.gen.apConfig.config.snmp.Syslocation;
import com.netconfessor.gen.apConfig.config.snmp.Sysname;
import com.netconfessor.gen.apConfig.config.snmp.Trap2sink;
import com.netconfessor.gen.apConfig.config.snmp.Trapcommunity;
import com.netconfessor.gen.apConfig.config.snmp.Trapsink;
...
public abstract class SnmpVisitor {
    ...
    public void setup() {
        setupEnable(new EnumYangData<>("enable", "/ap-config:config/ap-config:snmp/ap-config:enable", "Enable SNMP", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
