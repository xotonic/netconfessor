...
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.shaperPerStaRx.JValue;
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.shaperPerStaRx.Mode;
 ...
 * @author jnc.py
 */
public class ShaperPerStaRx extends YangElement implements YangContainer {
    ...
    /**
     * Constructor for an empty ShaperPerStaRx object.
     */
    public ShaperPerStaRx() {
        super(ApConfigSchema.NAMESPACE, "shaper-per-sta-rx");
    }
     ...
     */
    public ShaperPerStaRx clone() {
        return (ShaperPerStaRx)cloneContent(new ShaperPerStaRx());
    }
     ...
     */
    public ShaperPerStaRx cloneShallow() {
        return (ShaperPerStaRx)cloneShallowContent(new ShaperPerStaRx());
    }

    public ShaperPerStaRx cloneWithoutChildren() {
        return new ShaperPerStaRx();
    }
