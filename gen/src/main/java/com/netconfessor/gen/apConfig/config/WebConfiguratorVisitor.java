...
import com.netconfessor.gen.apConfig.config.webConfigurator.Enable;
import com.netconfessor.gen.apConfig.config.webConfigurator.HttpPort;
import com.netconfessor.gen.apConfig.config.webConfigurator.HttpsPort;
...
public abstract class WebConfiguratorVisitor {
    ...
    public void setup() {
        setupEnable(new EnumYangData<>("enable", "/ap-config:config/ap-config:web-configurator/ap-config:enable", "Enable or disable web interface", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
