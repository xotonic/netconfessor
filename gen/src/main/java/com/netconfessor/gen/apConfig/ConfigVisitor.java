...
import com.netconfessor.gen.apConfig.config.Authentication;
import com.netconfessor.gen.apConfig.config.AuthenticationVisitor;
import com.netconfessor.gen.apConfig.config.ConfigDescription;
import com.netconfessor.gen.apConfig.config.ConfigDescriptionVisitor;
import com.netconfessor.gen.apConfig.config.DateTime;
import com.netconfessor.gen.apConfig.config.DateTimeVisitor;
import com.netconfessor.gen.apConfig.config.JInterface;
import com.netconfessor.gen.apConfig.config.JInterfaceVisitor;
import com.netconfessor.gen.apConfig.config.Netconf;
import com.netconfessor.gen.apConfig.config.NetconfVisitor;
import com.netconfessor.gen.apConfig.config.Route;
import com.netconfessor.gen.apConfig.config.RouteVisitor;
import com.netconfessor.gen.apConfig.config.Snmp;
import com.netconfessor.gen.apConfig.config.SnmpVisitor;
import com.netconfessor.gen.apConfig.config.SystemVisitor;
import com.netconfessor.gen.apConfig.config.Trace;
import com.netconfessor.gen.apConfig.config.TraceVisitor;
import com.netconfessor.gen.apConfig.config.WebConfigurator;
import com.netconfessor.gen.apConfig.config.WebConfiguratorVisitor;
...
public abstract class ConfigVisitor {
    ...
    public abstract void onSystem(com.netconfessor.gen.apConfig.config.System container);
    ...
    public Config collectConfig() {
        ...
        if (systemVisitor != null) {
            com.netconfessor.gen.apConfig.config.System system = systemVisitor.collectConfig();
            if (system != null) {
    ...
    public void visit(NodeSet nodes) {
        ...
        if (system != null) {
            onSystem((com.netconfessor.gen.apConfig.config.System)system);
            if (systemVisitor != null) {
