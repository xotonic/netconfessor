...
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.radius.AcctAddress;
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.radius.AcctEnable;
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.radius.AcctInterval;
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.radius.AcctPassword;
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.radius.AcctPeriodic;
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.radius.AcctPort;
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.radius.AuthAddress;
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.radius.AuthPassword;
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.radius.AuthPort;
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.radius.Domain;
...
public abstract class RadiusVisitor {
    ...
    public void setup() {
        ...
        setupAuthAddress(new LeafYangData<>("auth-address", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:ap/ap-config:radius/ap-config:auth-address", "RADIUS authentication server address", true, YangDataType.leaf, "com.netconfessor.gen.ietfInetTypes.Host", s -> new Host(s)));
        setupDomain(new LeafYangData<>("domain", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:ap/ap-config:radius/ap-config:domain", "RADIUS authentication domain", true, YangDataType.leaf, "com.netconfessor.gen.ietfInetTypes.DomainName", s -> new DomainName(s)));
        ...
        setupAcctEnable(new EnumYangData<>("acct-enable", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:ap/ap-config:radius/ap-config:acct-enable", "Enable accounting", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        ...
        setupAcctPeriodic(new EnumYangData<>("acct-periodic", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:ap/ap-config:radius/ap-config:acct-periodic", "Enable periodic accounting updates", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        ...
        setupAcctAddress(new LeafYangData<>("acct-address", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:ap/ap-config:radius/ap-config:acct-address", "RADIUS accounting server address", true, YangDataType.leaf, "com.netconfessor.gen.ietfInetTypes.Host", s -> new Host(s)));
