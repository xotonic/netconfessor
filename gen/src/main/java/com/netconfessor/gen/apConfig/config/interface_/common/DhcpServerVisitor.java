...
import com.netconfessor.gen.apConfig.config.interface_.common.dhcpServer.StaticLeaseVisitor;
...
public abstract class DhcpServerVisitor {
    ...
    public void setup() {
        setupEnable(new EnumYangData<>("enable", "/ap-config:config/ap-config:interface/ap-config:common/ap-config:dhcp-server/ap-config:enable", "enable DHCP server on current interface", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        setupStartIp(new LeafYangData<>("start-ip", "/ap-config:config/ap-config:interface/ap-config:common/ap-config:dhcp-server/ap-config:start-ip", null, true, YangDataType.leaf, "com.netconfessor.gen.ietfInetTypes.IpAddress", s -> new IpAddress(s)));
        setupEndIp(new LeafYangData<>("end-ip", "/ap-config:config/ap-config:interface/ap-config:common/ap-config:dhcp-server/ap-config:end-ip", null, true, YangDataType.leaf, "com.netconfessor.gen.ietfInetTypes.IpAddress", s -> new IpAddress(s)));
        setupNetmask(new LeafYangData<>("netmask", "/ap-config:config/ap-config:interface/ap-config:common/ap-config:dhcp-server/ap-config:netmask", null, true, YangDataType.leaf, "com.netconfessor.gen.ietfInetTypes.IpAddress", s -> new IpAddress(s)));
        setupDns(new LeafYangData<>("dns", "/ap-config:config/ap-config:interface/ap-config:common/ap-config:dhcp-server/ap-config:dns", null, true, YangDataType.leaf, "com.netconfessor.gen.ietfInetTypes.IpAddress", s -> new IpAddress(s)));
        setupRouter(new LeafYangData<>("router", "/ap-config:config/ap-config:interface/ap-config:common/ap-config:dhcp-server/ap-config:router", null, true, YangDataType.leaf, "com.netconfessor.gen.ietfInetTypes.IpAddress", s -> new IpAddress(s)));
