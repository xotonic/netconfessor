...
import com.netconfessor.gen.apConfig.config.interface_.gre.Basic;
import com.netconfessor.gen.apConfig.config.interface_.gre.Linkname;
import com.netconfessor.gen.apConfig.config.interface_.gre.Remote;
...
public abstract class GreVisitor {
    ...
    public void setup() {
        ...
        setupRemote(new LeafYangData<>("remote", "/ap-config:config/ap-config:interface/ap-config:gre/ap-config:remote", "Remote IP address", true, YangDataType.leaf, "com.netconfessor.gen.ietfInetTypes.IpAddress", s -> new IpAddress(s)));
