...
import com.netconfessor.gen.apConfig.Enum_staticIp_dhcp;
import com.netconfessor.gen.apConfig.config.interface_.Common;
import com.netconfessor.gen.apConfig.config.interface_.common.AccessRules;
import com.netconfessor.gen.apConfig.config.interface_.common.AccessRulesVisitor;
import com.netconfessor.gen.apConfig.config.interface_.common.DhcpServer;
import com.netconfessor.gen.apConfig.config.interface_.common.DhcpServerVisitor;
...
public abstract class CommonVisitor {
    ...
    public void setup() {
        setupType(new EnumYangData<>("type", "/ap-config:config/ap-config:interface/ap-config:common/ap-config:type", "Interface type", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_eth_vlan_wlan_bridge_vap_gre", s -> new Enum_eth_vlan_wlan_bridge_vap_gre(s), Enum_eth_vlan_wlan_bridge_vap_gre.enums()));
        ...
        setupEnabled(new EnumYangData<>("enabled", "/ap-config:config/ap-config:interface/ap-config:common/ap-config:enabled", "Enable interface", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        setupWan(new EnumYangData<>("wan", "/ap-config:config/ap-config:interface/ap-config:common/ap-config:wan", "WAN mode on interface", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        setupMasquerade(new EnumYangData<>("masquerade", "/ap-config:config/ap-config:interface/ap-config:common/ap-config:masquerade", "enable masquerading on interface", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        setupProtocol(new EnumYangData<>("protocol", "/ap-config:config/ap-config:interface/ap-config:common/ap-config:protocol", "Setup protocol for configuring IP params", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_staticIp_dhcp", s -> new Enum_staticIp_dhcp(s), Enum_staticIp_dhcp.enums()));
        setupDisableBroadcastDhcp(new EnumYangData<>("disable-broadcast-dhcp", "/ap-config:config/ap-config:interface/ap-config:common/ap-config:disable-broadcast-dhcp", "Request unicast replies for DHCP", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        setupStaticIp(new LeafYangData<>("static-ip", "/ap-config:config/ap-config:interface/ap-config:common/ap-config:static-ip", "Static IP address", true, YangDataType.leaf, "com.netconfessor.gen.ietfInetTypes.IpAddress", s -> new IpAddress(s)));
        setupNetmask(new LeafYangData<>("netmask", "/ap-config:config/ap-config:interface/ap-config:common/ap-config:netmask", "Netmask for static IP mode", true, YangDataType.leaf, "com.netconfessor.gen.ietfInetTypes.IpAddress", s -> new IpAddress(s)));
        setupDnsServer1(new LeafYangData<>("dns-server-1", "/ap-config:config/ap-config:interface/ap-config:common/ap-config:dns-server-1", "DNS server IP address", true, YangDataType.leaf, "com.netconfessor.gen.ietfInetTypes.IpAddress", s -> new IpAddress(s)));
        setupDnsServer2(new LeafYangData<>("dns-server-2", "/ap-config:config/ap-config:interface/ap-config:common/ap-config:dns-server-2", "DNS server IP address", true, YangDataType.leaf, "com.netconfessor.gen.ietfInetTypes.IpAddress", s -> new IpAddress(s)));
