...
import com.netconfessor.gen.apConfig.config.interface_.vap.shaperPerVapTx.JValue;
import com.netconfessor.gen.apConfig.config.interface_.vap.shaperPerVapTx.Mode;
...
public abstract class ShaperPerVapTxVisitor {
    ...
    public void setup() {
        setupMode(new EnumYangData<>("mode", "/ap-config:config/ap-config:interface/ap-config:vap/ap-config:shaper-per-vap-tx/ap-config:mode", "Shaper work-mode", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_off_pps_kbps", s -> new Enum_off_pps_kbps(s), Enum_off_pps_kbps.enums()));
