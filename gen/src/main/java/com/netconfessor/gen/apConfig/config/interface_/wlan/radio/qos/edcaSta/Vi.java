 ...
 * @author jnc.py
 */
public class Vi extends YangElement implements YangContainer {
    ...
    /**
     * Constructor for an empty Vi object.
     */
    public Vi() {
        super(ApConfigSchema.NAMESPACE, "vi");
    }
     ...
     */
    public Vi cloneShallow() {
        return (Vi)cloneShallowContent(new Vi());
    }

    public Vi cloneWithoutChildren() {
        return new Vi();
    }
