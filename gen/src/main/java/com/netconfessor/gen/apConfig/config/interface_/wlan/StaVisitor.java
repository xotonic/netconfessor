...
import com.netconfessor.gen.apConfig.Enum_off_manual_auto;
...
import com.netconfessor.gen.apConfig.config.interface_.wlan.sta.RadiusVisitor;
...
public abstract class StaVisitor {
    ...
    public void setup() {
        ...
        setupClientShaperMode(new EnumYangData<>("client-shaper-mode", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:sta/ap-config:client-shaper-mode", "Client side shaper mode", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_off_manual_auto", s -> new Enum_off_manual_auto(s), Enum_off_manual_auto.enums()));
        ...
        setupVlanSupport(new EnumYangData<>("vlan-support", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:sta/ap-config:vlan-support", "Realtek specific option, need always 1 for VLAN support", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
