...
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.AclVisitor;
...
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.RadiusVisitor;
...
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.ShaperPerStaRxVisitor;
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.ShaperPerStaTx;
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.ShaperPerStaTxVisitor;
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.ShaperPerVapRx;
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.ShaperPerVapRxVisitor;
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.ShaperPerVapTx;
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.ShaperPerVapTxVisitor;
...
public abstract class ApVisitor {
    ...
    public void setup() {
        ...
        setupStationIsolation(new EnumYangData<>("station-isolation", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:ap/ap-config:station-isolation", "Station isolation", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        ...
        setupVlanPriority(new EnumYangData<>("vlan-priority", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:ap/ap-config:vlan-priority", "VLAN priority", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_auto_0_1_2_3_4_5_6_7", s -> new Enum_auto_0_1_2_3_4_5_6_7(s), Enum_auto_0_1_2_3_4_5_6_7.enums()));
        setupVlanTrunk(new EnumYangData<>("vlan-trunk", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:ap/ap-config:vlan-trunk", "VLAN trunk feature", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        setupVlanSupport(new EnumYangData<>("vlan-support", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:ap/ap-config:vlan-support", "Realtek specific option, need always 1 for VLAN support", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        ...
        setupHidden(new EnumYangData<>("hidden", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:ap/ap-config:hidden", "Hidden AP mode", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        ...
        setupIapp(new EnumYangData<>("iapp", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:ap/ap-config:iapp", "IAPP", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
