...
import com.netconfessor.gen.apConfig.config.interface_.vap.shaperPerStaTx.JValue;
import com.netconfessor.gen.apConfig.config.interface_.vap.shaperPerStaTx.Mode;
...
public abstract class ShaperPerStaTxVisitor {
    ...
    public void setup() {
        setupMode(new EnumYangData<>("mode", "/ap-config:config/ap-config:interface/ap-config:vap/ap-config:shaper-per-sta-tx/ap-config:mode", "Shaper work-mode", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_off_pps_kbps", s -> new Enum_off_pps_kbps(s), Enum_off_pps_kbps.enums()));
