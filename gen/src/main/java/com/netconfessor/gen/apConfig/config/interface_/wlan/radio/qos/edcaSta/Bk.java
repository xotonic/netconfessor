 ...
 * @author jnc.py
 */
public class Bk extends YangElement implements YangContainer {
    ...
    /**
     * Constructor for an empty Bk object.
     */
    public Bk() {
        super(ApConfigSchema.NAMESPACE, "bk");
    }
     ...
     */
    public Bk cloneShallow() {
        return (Bk)cloneShallowContent(new Bk());
    }

    public Bk cloneWithoutChildren() {
        return new Bk();
    }
