 ...
 * @author jnc.py
 */
public class EdcaAp extends YangElement implements YangContainer {
    ...
    /**
     * Constructor for an empty EdcaAp object.
     */
    public EdcaAp() {
        super(ApConfigSchema.NAMESPACE, "edca-ap");
    }
     ...
     */
    public EdcaAp clone() {
        return (EdcaAp)cloneContent(new EdcaAp());
    }
     ...
     */
    public EdcaAp cloneShallow() {
        return (EdcaAp)cloneShallowContent(new EdcaAp());
    }

    public EdcaAp cloneWithoutChildren() {
        return new EdcaAp();
    }
