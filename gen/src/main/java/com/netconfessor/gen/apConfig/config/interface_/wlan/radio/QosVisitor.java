...
import com.netconfessor.gen.apConfig.config.interface_.wlan.radio.qos.EdcaApVisitor;
import com.netconfessor.gen.apConfig.config.interface_.wlan.radio.qos.EdcaSta;
import com.netconfessor.gen.apConfig.config.interface_.wlan.radio.qos.EdcaStaVisitor;
import com.netconfessor.gen.apConfig.config.interface_.wlan.radio.qos.Enable;
...
public abstract class QosVisitor {
    ...
    public void setup() {
        setupEnable(new EnumYangData<>("enable", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:radio/ap-config:qos/ap-config:enable", "Enable/disable QoS", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
