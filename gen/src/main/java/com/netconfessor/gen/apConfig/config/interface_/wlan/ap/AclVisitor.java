...
import com.netconfessor.gen.apConfig.Enum_blacklist_whitelist;
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.Acl;
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.acl.Mac;
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.acl.MacVisitor;
import com.netconfessor.gen.apConfig.config.interface_.wlan.ap.acl.Mode;
...
public abstract class AclVisitor {
    ...
    public void setup() {
        setupMode(new EnumYangData<>("mode", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:ap/ap-config:acl/ap-config:mode", "ACL work-mode", true, YangDataType.leaf, "com.netconfessor.gen.apConfig.Enum_blacklist_whitelist", s -> new Enum_blacklist_whitelist(s), Enum_blacklist_whitelist.enums()));
