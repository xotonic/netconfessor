...
import io.netconfessor.gen.apConfig.config.interface_.vap.radius.AcctAddress;
import io.netconfessor.gen.apConfig.config.interface_.vap.radius.AcctEnable;
import io.netconfessor.gen.apConfig.config.interface_.vap.radius.AcctInterval;
import io.netconfessor.gen.apConfig.config.interface_.vap.radius.AcctPassword;
import io.netconfessor.gen.apConfig.config.interface_.vap.radius.AcctPeriodic;
import io.netconfessor.gen.apConfig.config.interface_.vap.radius.AcctPort;
import io.netconfessor.gen.apConfig.config.interface_.vap.radius.AuthAddress;
import io.netconfessor.gen.apConfig.config.interface_.vap.radius.AuthPassword;
import io.netconfessor.gen.apConfig.config.interface_.vap.radius.AuthPort;
import io.netconfessor.gen.apConfig.config.interface_.vap.radius.Domain;
...
public abstract class RadiusVisitor {
    ...
    public void setup() {
        ...
        setupAuthAddress(new LeafYangData<>("auth-address", "/ap-config:config/ap-config:interface/ap-config:vap/ap-config:radius/ap-config:auth-address", "RADIUS authentication server address", true, YangDataType.leaf, "io.netconfessor.gen.ietfInetTypes.Host", s -> new Host(s)));
        ...
        setupAcctEnable(new EnumYangData<>("acct-enable", "/ap-config:config/ap-config:interface/ap-config:vap/ap-config:radius/ap-config:acct-enable", "Enable accounting", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        ...
        setupAcctAddress(new LeafYangData<>("acct-address", "/ap-config:config/ap-config:interface/ap-config:vap/ap-config:radius/ap-config:acct-address", "RADIUS accounting server address", true, YangDataType.leaf, "io.netconfessor.gen.ietfInetTypes.Host", s -> new Host(s)));
        ...
        setupAcctPeriodic(new EnumYangData<>("acct-periodic", "/ap-config:config/ap-config:interface/ap-config:vap/ap-config:radius/ap-config:acct-periodic", "Enable periodic accounting updates", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        ...
        setupDomain(new LeafYangData<>("domain", "/ap-config:config/ap-config:interface/ap-config:vap/ap-config:radius/ap-config:domain", "RADIUS authentication domain", true, YangDataType.leaf, "io.netconfessor.gen.ietfInetTypes.DomainName", s -> new DomainName(s)));
    }
