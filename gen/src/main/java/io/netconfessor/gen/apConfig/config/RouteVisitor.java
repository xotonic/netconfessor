...
import io.netconfessor.gen.apConfig.config.route.Destination;
import io.netconfessor.gen.apConfig.config.route.Gateway;
import io.netconfessor.gen.apConfig.config.route.Name;
import io.netconfessor.gen.apConfig.config.route.Netmask;
...
public abstract class RouteVisitor {
    ...
    public void setup() {
        ...
        setupDestination(new LeafYangData<>("destination", "/ap-config:config/ap-config:route/ap-config:destination", "Route destination address", true, YangDataType.leaf, "io.netconfessor.gen.ietfInetTypes.IpAddress", s -> new IpAddress(s)));
        setupNetmask(new LeafYangData<>("netmask", "/ap-config:config/ap-config:route/ap-config:netmask", "Route netmask", true, YangDataType.leaf, "io.netconfessor.gen.ietfInetTypes.IpAddress", s -> new IpAddress(s)));
        setupGateway(new LeafYangData<>("gateway", "/ap-config:config/ap-config:route/ap-config:gateway", "Route gateway", true, YangDataType.leaf, "io.netconfessor.gen.ietfInetTypes.IpAddress", s -> new IpAddress(s)));
    }
