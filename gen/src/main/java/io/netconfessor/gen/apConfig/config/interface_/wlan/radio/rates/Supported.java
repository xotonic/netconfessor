 ...
 * @author jnc.py
 */
public class Supported extends YangElement implements YangContainer {
    ...
    /**
     * Constructor for an empty Supported object.
     */
    public Supported() {
        super(ApConfigSchema.NAMESPACE, "supported");
    }
     ...
     */
    public Supported clone() {
        return (Supported)cloneContent(new Supported());
    }
     ...
     */
    public Supported cloneShallow() {
        return (Supported)cloneShallowContent(new Supported());
    }

    public Supported cloneWithoutChildren() {
