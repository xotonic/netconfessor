...
import io.netconfessor.gen.apConfig.config.interface_.wlan.ap.shaperPerVapTx.JValue;
import io.netconfessor.gen.apConfig.config.interface_.wlan.ap.shaperPerVapTx.Mode;
 ...
 * @author jnc.py
 */
public class ShaperPerVapTx extends YangElement implements YangContainer {
    ...
    /**
     * Constructor for an empty ShaperPerVapTx object.
     */
    public ShaperPerVapTx() {
        super(ApConfigSchema.NAMESPACE, "shaper-per-vap-tx");
    }
     ...
     */
    public ShaperPerVapTx clone() {
        return (ShaperPerVapTx)cloneContent(new ShaperPerVapTx());
    }
     ...
     */
    public ShaperPerVapTx cloneShallow() {
        return (ShaperPerVapTx)cloneShallowContent(new ShaperPerVapTx());
    }

    public ShaperPerVapTx cloneWithoutChildren() {
        return new ShaperPerVapTx();
    }
