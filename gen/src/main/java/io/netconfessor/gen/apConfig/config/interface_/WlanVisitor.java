...
import io.netconfessor.gen.apConfig.Enum_ap_sta_radio;
import io.netconfessor.gen.apConfig.config.interface_.Wlan;
import io.netconfessor.gen.apConfig.config.interface_.wlan.Ap;
import io.netconfessor.gen.apConfig.config.interface_.wlan.ApVisitor;
import io.netconfessor.gen.apConfig.config.interface_.wlan.Mode;
import io.netconfessor.gen.apConfig.config.interface_.wlan.Radio;
import io.netconfessor.gen.apConfig.config.interface_.wlan.RadioVisitor;
import io.netconfessor.gen.apConfig.config.interface_.wlan.RssiIndication;
import io.netconfessor.gen.apConfig.config.interface_.wlan.Sta;
import io.netconfessor.gen.apConfig.config.interface_.wlan.StaVisitor;
...
public abstract class WlanVisitor {
    ...
    public void setup() {
        setupMode(new EnumYangData<>("mode", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:mode", "AP/STA mode of WLAN interface", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_ap_sta_radio", s -> new Enum_ap_sta_radio(s), Enum_ap_sta_radio.enums()));
        setupRssiIndication(new EnumYangData<>("rssi-indication", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:rssi-indication", "Indicate RSSI from current interface by RSSI LEDs", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
