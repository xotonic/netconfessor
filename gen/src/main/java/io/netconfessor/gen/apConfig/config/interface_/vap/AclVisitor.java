...
import io.netconfessor.gen.apConfig.Enum_blacklist_whitelist_off;
import io.netconfessor.gen.apConfig.config.interface_.vap.Acl;
import io.netconfessor.gen.apConfig.config.interface_.vap.acl.Mac;
import io.netconfessor.gen.apConfig.config.interface_.vap.acl.MacVisitor;
import io.netconfessor.gen.apConfig.config.interface_.vap.acl.Mode;
...
public abstract class AclVisitor {
    ...
    public void setup() {
        setupMode(new EnumYangData<>("mode", "/ap-config:config/ap-config:interface/ap-config:vap/ap-config:acl/ap-config:mode", "ACL work-mode", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_blacklist_whitelist_off", s -> new Enum_blacklist_whitelist_off(s), Enum_blacklist_whitelist_off.enums()));
