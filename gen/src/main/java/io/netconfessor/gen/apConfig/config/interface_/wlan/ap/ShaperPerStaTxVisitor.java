...
import io.netconfessor.gen.apConfig.config.interface_.wlan.ap.shaperPerStaTx.JValue;
import io.netconfessor.gen.apConfig.config.interface_.wlan.ap.shaperPerStaTx.Mode;
...
public abstract class ShaperPerStaTxVisitor {
    ...
    public void setup() {
        setupMode(new EnumYangData<>("mode", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:ap/ap-config:shaper-per-sta-tx/ap-config:mode", "Shaper work-mode", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_off_pps_kbps", s -> new Enum_off_pps_kbps(s), Enum_off_pps_kbps.enums()));
