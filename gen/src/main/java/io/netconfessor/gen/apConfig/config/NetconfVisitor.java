...
import io.netconfessor.gen.apConfig.config.netconf.Enable;
...
public abstract class NetconfVisitor {
    ...
    public void setup() {
        setupEnable(new EnumYangData<>("enable", "/ap-config:config/ap-config:netconf/ap-config:enable", "Enable NETCONF", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
    }
