 ...
 * @author jnc.py
 */
public class Error extends Leaf {
    ...
    /**
     * Sets the value  leaf "error",
     * @param errorValue used during instantiation.
     */
    public void value(Enum_0_1 errorValue) throws JNCException {
        setValue(errorValue);
    }
    ...
    /**
     * Constructor for an empty Error object.
     */
    public Error() {
        super(ApConfigSchema.NAMESPACE, "error");
    }

    /**
     * Constructor for an empty Error object.
     */
    public Error(Enum_0_1 value) {
        super(ApConfigSchema.NAMESPACE, "error");
        this.value(value);
    }
     ...
     */
    public Error clone() {
        return (Error)cloneContent(new Error());
    }
     ...
     */
    public Error cloneShallow() {
        return (Error)cloneShallowContent(new Error());
    }

    public Error cloneWithoutChildren() {
        return new Error();
    }
