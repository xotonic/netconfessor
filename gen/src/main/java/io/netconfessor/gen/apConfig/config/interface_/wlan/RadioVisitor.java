...
import io.netconfessor.gen.apConfig.Enum_a_an_ac;
import io.netconfessor.gen.apConfig.Enum_disabled_auto_forced;
import io.netconfessor.gen.apConfig.Enum_ru_us;
import io.netconfessor.gen.apConfig.Enum_upper_lower;
import io.netconfessor.gen.apConfig.config.interface_.wlan.Radio;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.AckTimeout;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.Aggregation;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.AtfIftime;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.Bandwidth;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.BeaconInterval;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.Beamforming;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.Channel;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.ControlSideband;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.Country;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.Dfs;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.DisableAtf;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.EnableFixedRate;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.FbwaMode;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.FixedRate;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.FragmentationThreshold;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.ObssCoex;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.ProtectionDisabled;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.Qos;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.QosVisitor;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.Rates;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.RatesVisitor;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.RtsThreshold;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.Sgi;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.ShortPreamble;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.Stbc;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.Tdma;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.TdmaTxDuration;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.TxBroadcastLimit;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.TxPower;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.VapEnable;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.Wmm;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.WorkMode;
...
public abstract class RadioVisitor {
    ...
    public void setup() {
        setupCountry(new EnumYangData<>("country", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:radio/ap-config:country", "Country code", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_ru_us", s -> new Enum_ru_us(s), Enum_ru_us.enums()));
        setupWorkMode(new EnumYangData<>("work-mode", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:radio/ap-config:work-mode", "IEEE 802.11 operation mode", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_a_an_ac", s -> new Enum_a_an_ac(s), Enum_a_an_ac.enums()));
        setupBandwidth(new EnumYangData<>("bandwidth", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:radio/ap-config:bandwidth", "Channel bandwidth", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_5_10_20_40_80", s -> new Enum_5_10_20_40_80(s), Enum_5_10_20_40_80.enums()));
        setupDisableAtf(new EnumYangData<>("disable-atf", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:radio/ap-config:disable-atf", "Disable ATF", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        setupTdma(new EnumYangData<>("tdma", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:radio/ap-config:tdma", "TDMA mode", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        ...
        setupWmm(new EnumYangData<>("wmm", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:radio/ap-config:wmm", "WMM feature", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        setupVapEnable(new EnumYangData<>("vap-enable", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:radio/ap-config:vap-enable", "Enable VAP support", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        ...
        setupShortPreamble(new EnumYangData<>("short-preamble", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:radio/ap-config:short-preamble", "Short preamble", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        setupAggregation(new EnumYangData<>("aggregation", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:radio/ap-config:aggregation", "Aggregation", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        setupSgi(new EnumYangData<>("sgi", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:radio/ap-config:sgi", "Short guard interval", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        setupStbc(new EnumYangData<>("stbc", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:radio/ap-config:stbc", "STBC encoding", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        setupObssCoex(new EnumYangData<>("obss-coex", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:radio/ap-config:obss-coex", "OBSS coexistance", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        setupBeamforming(new EnumYangData<>("beamforming", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:radio/ap-config:beamforming", "Beamforming", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        ...
        setupProtectionDisabled(new EnumYangData<>("protection-disabled", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:radio/ap-config:protection-disabled", "Protection mode", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        ...
        setupEnableFixedRate(new EnumYangData<>("enable-fixed-rate", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:radio/ap-config:enable-fixed-rate", "Enable fixed TX rate", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        ...
        setupDfs(new EnumYangData<>("dfs", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:radio/ap-config:dfs", "DFS support", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_disabled_auto_forced", s -> new Enum_disabled_auto_forced(s), Enum_disabled_auto_forced.enums()));
        setupFbwaMode(new EnumYangData<>("fbwa-mode", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:radio/ap-config:fbwa-mode", "Fixed broadband wireless access mode", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
