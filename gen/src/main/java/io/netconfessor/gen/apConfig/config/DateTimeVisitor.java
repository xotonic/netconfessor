...
import io.netconfessor.gen.apConfig.config.dateTime.CommonVisitor;
import io.netconfessor.gen.apConfig.config.dateTime.Manual;
import io.netconfessor.gen.apConfig.config.dateTime.ManualVisitor;
import io.netconfessor.gen.apConfig.config.dateTime.Mode;
import io.netconfessor.gen.apConfig.config.dateTime.Ntp;
import io.netconfessor.gen.apConfig.config.dateTime.NtpVisitor;
...
public abstract class DateTimeVisitor {
    ...
    public void setup() {
        setupMode(new EnumYangData<>("mode", "/ap-config:config/ap-config:date-time/ap-config:mode", "Setup date-time mode", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_manual_ntp", s -> new Enum_manual_ntp(s), Enum_manual_ntp.enums()));
