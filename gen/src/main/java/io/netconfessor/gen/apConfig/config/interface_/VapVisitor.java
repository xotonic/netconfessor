...
import io.netconfessor.gen.apConfig.config.interface_.vap.Acl;
import io.netconfessor.gen.apConfig.config.interface_.vap.AclVisitor;
import io.netconfessor.gen.apConfig.config.interface_.vap.Basic;
import io.netconfessor.gen.apConfig.config.interface_.vap.Hidden;
import io.netconfessor.gen.apConfig.config.interface_.vap.InactivityTimeout;
import io.netconfessor.gen.apConfig.config.interface_.vap.KeyWep;
import io.netconfessor.gen.apConfig.config.interface_.vap.KeyWpa;
import io.netconfessor.gen.apConfig.config.interface_.vap.PriorityByDscp;
import io.netconfessor.gen.apConfig.config.interface_.vap.Radius;
import io.netconfessor.gen.apConfig.config.interface_.vap.RadiusVisitor;
import io.netconfessor.gen.apConfig.config.interface_.vap.SecurityMode;
import io.netconfessor.gen.apConfig.config.interface_.vap.ShaperPerStaRx;
import io.netconfessor.gen.apConfig.config.interface_.vap.ShaperPerStaRxVisitor;
import io.netconfessor.gen.apConfig.config.interface_.vap.ShaperPerStaTx;
import io.netconfessor.gen.apConfig.config.interface_.vap.ShaperPerStaTxVisitor;
import io.netconfessor.gen.apConfig.config.interface_.vap.ShaperPerVapRx;
import io.netconfessor.gen.apConfig.config.interface_.vap.ShaperPerVapRxVisitor;
import io.netconfessor.gen.apConfig.config.interface_.vap.ShaperPerVapTx;
import io.netconfessor.gen.apConfig.config.interface_.vap.ShaperPerVapTxVisitor;
import io.netconfessor.gen.apConfig.config.interface_.vap.Ssid;
import io.netconfessor.gen.apConfig.config.interface_.vap.StaLimit;
import io.netconfessor.gen.apConfig.config.interface_.vap.StationIsolation;
import io.netconfessor.gen.apConfig.config.interface_.vap.VapId;
import io.netconfessor.gen.apConfig.config.interface_.vap.VlanId;
import io.netconfessor.gen.apConfig.config.interface_.vap.VlanPriority;
import io.netconfessor.gen.apConfig.config.interface_.vap.VlanSupport;
import io.netconfessor.gen.apConfig.config.interface_.vap.VlanTrunk;
...
public abstract class VapVisitor {
    ...
    public void setup() {
        ...
        setupHidden(new EnumYangData<>("hidden", "/ap-config:config/ap-config:interface/ap-config:vap/ap-config:hidden", "Hidden AP mode", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        setupStationIsolation(new EnumYangData<>("station-isolation", "/ap-config:config/ap-config:interface/ap-config:vap/ap-config:station-isolation", "Station isolation", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        ...
        setupVlanPriority(new EnumYangData<>("vlan-priority", "/ap-config:config/ap-config:interface/ap-config:vap/ap-config:vlan-priority", "VLAN priority", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_auto_0_1_2_3_4_5_6_7", s -> new Enum_auto_0_1_2_3_4_5_6_7(s), Enum_auto_0_1_2_3_4_5_6_7.enums()));
        setupVlanTrunk(new EnumYangData<>("vlan-trunk", "/ap-config:config/ap-config:interface/ap-config:vap/ap-config:vlan-trunk", "VLAN trunk feature", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
        setupVlanSupport(new EnumYangData<>("vlan-support", "/ap-config:config/ap-config:interface/ap-config:vap/ap-config:vlan-support", "Realtek specific option, need always 1 for VLAN support", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
