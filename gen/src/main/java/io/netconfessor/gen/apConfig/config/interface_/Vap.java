 ...
 * @author jnc.py
 */
public class Vap extends YangElement implements YangContainer {
    ...
    /**
     * Field for child leaf "vap-id".
     */
    public VapId vapId = null;
    ...
    /**
     * Constructor for an empty Vap object.
     */
    public Vap() {
        super(ApConfigSchema.NAMESPACE, "vap");
    }
     ...
     */
    public Vap clone() {
        return (Vap)cloneContent(new Vap());
    }
     ...
     */
    public Vap cloneShallow() {
        return (Vap)cloneShallowContent(new Vap());
    }

    public Vap cloneWithoutChildren() {
        return new Vap();
    }
    ...
    /* Access methods for optional leaf child: "vap-id". */

    /**
     * Adds leaf entry "vapId", using an existing object.
     * @param vapId The object to add.
     * @return The added child.
     */
    public VapId addVapId(VapId vapId) throws JNCException {
        this.vapId = vapId;
        insertChild(vapId, childrenNames());
        return vapId;
    }

    /**
     * Adds leaf entry "vapId".
     * This method is used for creating subtree filters.
     * @return The added child.
     */
    public VapId addVapId() throws JNCException {
        VapId vapId = new VapId();
        this.vapId = vapId;
        insertChild(vapId, childrenNames());
        return vapId;
    }
    ...
    /**
     * Deletes leaf entry "vapId".
     * @return An array of the deleted element nodes.
     */
    public NodeSet deleteVapId() throws JNCException {
        this.vapId = null;
        String path = "vap-id";
        return delete(path);
    }
    ...
    public void addChild(Element child) {
        ...
        else if (child instanceof VapId) vapId = (VapId)child;
        else if (child instanceof Acl) acl = (Acl)child;
