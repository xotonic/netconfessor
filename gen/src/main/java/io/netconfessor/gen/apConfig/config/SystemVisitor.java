...
import io.netconfessor.gen.apConfig.config.system.GlobalStationIsolation;
...
public abstract class SystemVisitor {
    ...
    public void setup() {
        setupGlobalStationIsolation(new EnumYangData<>("global-station-isolation", "/ap-config:config/ap-config:system/ap-config:global-station-isolation", "Full isolation", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_0_1", s -> new Enum_0_1(s), Enum_0_1.enums()));
    }

    /**
     * Retrieve all config values in registered visitors
     */
    public io.netconfessor.gen.apConfig.config.System collectConfig() {
