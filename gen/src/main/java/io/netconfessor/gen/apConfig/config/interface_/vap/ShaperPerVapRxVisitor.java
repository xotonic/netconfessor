...
import io.netconfessor.gen.apConfig.config.interface_.vap.shaperPerVapRx.JValue;
import io.netconfessor.gen.apConfig.config.interface_.vap.shaperPerVapRx.Mode;
...
public abstract class ShaperPerVapRxVisitor {
    ...
    public void setup() {
        setupMode(new EnumYangData<>("mode", "/ap-config:config/ap-config:interface/ap-config:vap/ap-config:shaper-per-vap-rx/ap-config:mode", "Shaper work-mode", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_off_pps_kbps", s -> new Enum_off_pps_kbps(s), Enum_off_pps_kbps.enums()));
        setupJValue(new LeafYangData<>("value", "/ap-config:config/ap-config:interface/ap-config:vap/ap-config:shaper-per-vap-rx/ap-config:value", "Shaper value", true, YangDataType.leaf, "io.netconfessor.YangInt32", s -> new YangInt32(s)));
    }
