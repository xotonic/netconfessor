...
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.qos.edcaAp.vo.Acm;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.qos.edcaAp.vo.Aifs;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.qos.edcaAp.vo.Cwmax;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.qos.edcaAp.vo.Cwmin;
import io.netconfessor.gen.apConfig.config.interface_.wlan.radio.qos.edcaAp.vo.Txop;
...
public abstract class VoVisitor {
    ...
    public void setup() {
        ...
        setupCwmin(new EnumYangData<>("cwmin", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:radio/ap-config:qos/ap-config:edca-ap/ap-config:vo/ap-config:cwmin", "Contention window minimum", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_1_3_7_15_31_63_127_255_511_1023", s -> new Enum_1_3_7_15_31_63_127_255_511_1023(s), Enum_1_3_7_15_31_63_127_255_511_1023.enums()));
        setupCwmax(new EnumYangData<>("cwmax", "/ap-config:config/ap-config:interface/ap-config:wlan/ap-config:radio/ap-config:qos/ap-config:edca-ap/ap-config:vo/ap-config:cwmax", "Contention window maximum", true, YangDataType.leaf, "io.netconfessor.gen.apConfig.Enum_1_3_7_15_31_63_127_255_511_1023", s -> new Enum_1_3_7_15_31_63_127_255_511_1023(s), Enum_1_3_7_15_31_63_127_255_511_1023.enums()));
